...
let btn_delete_task_list = document.querySelectorAll('#btn_delete_task_list');

const modal_delete_task_list = document.getElementById('modal_delete_task_list');

// Get button to confirm delete task list
const delete_save_task_list_button = document.getElementById('delete_save_task_list_button');

// Open modal delete task list
btn_delete_task_list.forEach((btn)=>{
    btn.addEventListener('click', ()=>{
        id_task_list = btn.getAttribute('data-id');
        console.log(id_task_list);
...
delete_save_task_list_button.addEventListener('click', async (e) => {
    ...
    const message_loader_delete = document.getElementById('message_loader_delete_modal');
...
const modal_close_delete_svg = document.getElementById('modal_close_delete_svg');
const modal_close_delete_footer_btn = document.getElementById('modal_close_delete_footer_btn');

// Close modal delete task list
modal_delete_task_list.addEventListener('click', (e) => {
    if (e.target === modal_delete_task_list || e.target === modal_close_delete_svg || e.target === modal_close_delete_footer_btn) {
        close_modal(modal_delete_task_list);
    }
